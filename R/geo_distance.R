...
gcd.slc.wsg84 <- function(long1, lat1, long2, lat2) {
	# Convert degrees to radians
	long1 <- deg2rad(long1)
  	lat1 <- deg2rad(lat1)
  	long2 <- deg2rad(long2)
...
gcd.hf.wsg84 <- function(long1, lat1, long2, lat2) {
	# Convert degrees to radians
	long1 <- deg2rad(long1)
  	lat1 <- deg2rad(lat1)
  	long2 <- deg2rad(long2)
  	lat2 <- deg2rad(lat2)
	return(gcd.hf(long1, lat1, long2, lat2))
}
...
gcd.vif.wsg84 <- function(long1, lat1, long2, lat2) {
	# Convert degrees to radians
	long1 <- deg2rad(long1)
  	lat1 <- deg2rad(lat1)
  	long2 <- deg2rad(long2)
